...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "不完美的艺术"
  # s.authors            = { "不完美的艺术" => "xin963744135@163.com" }
  # s.social_media_url   = "http://twitter.com/不完美的艺术"
  ...
  # s.source       = { :git => "https://github.com/h1101723183/AliPaySDK.git" }
 s.source       = { :git => "https://github.com/h1101723183/AliPaySDK.git", :tag => "15.5.0" }
